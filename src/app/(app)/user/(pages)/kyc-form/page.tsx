...
import { uploadKycPhoto } from "@/lib/actions/user";
    ...
    <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="bg-white rounded-xl shadow p-4 sm:p-6 flex-1 min-w-[0]">
            ...
            <p className="mb-4 text-sm sm:text-base">
                In order to receive and send funds with your qfspatriotledger.com account, the law requires us to collect identifying information on our clients and keep it up to date.
            </p>
            <p className="text-sm sm:text-base">
                qfspatriotledger.com follows the regulations as required for KYC Verification. All data uploaded by customers are fully encrypted and will never be shared with third-parties.
            </p>
            </div>
            <hr className="my-4" />

    ...
    <div className="flex flex-col md:flex-row gap-6">
      <div className="bg-white rounded-xl shadow p-4 sm:p-6 w-full max-w-md h-min">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="block text-black mb-1 text-xs font-semibold">Send From</label>
            <select required className="w-full border rounded px-3 py-2 focus:outline-none focus:border-[#42a5f5]">
        ...
        <Dialog open={show} onOpenChange={setShow}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Your deposit is under review for admin approval. Please be patient.
              </DialogDescription>
            </DialogHeader>

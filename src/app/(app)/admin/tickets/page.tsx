    ...
    return (
      <div className="md:px-4">
        <div className="flex justify-end mb-6">
          <Link href="/user/ticket/new" className="bg-[#21ce99] text-white font-semibold rounded-lg px-6 py-2 text-base shadow-none hover:opacity-90 transition">
            Open Support Ticket
          </Link>
        </div>
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <Table>
            ...
            <TableBody>
              <TableRow>
                <TableCell colSpan={5} className="text-center text-[#a0a0b2] py-6">
                  There was an error while displaying data. Please check your internet connection and refresh the page.
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
